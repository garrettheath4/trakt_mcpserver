...
from trakt_mcp_server.config.auth import AUTH_VERIFICATION_URL
from trakt_mcp_server.utils.api.error_types import AuthenticationRequiredError
from trakt_mcp_server.utils.api.errors import InternalError, InvalidParamsError, MCPError
from trakt_mcp_server.utils.api.request_context import add_context_to_error_data
from trakt_mcp_server.utils.api.structured_logging import get_structured_logger
